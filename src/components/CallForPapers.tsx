    ...
    <div className="min-h-screen text-gray-800 font-sans w-screen flex flex-col items-center">
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-24 px-4 text-center w-full relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-5xl font-extrabold mb-6">6th IEEE India Council International Subsections Conference</h1>
          <p className="text-2xl mb-4">Theme: &ldquo;Smart and Sustainable Technologies for Society&rdquo;</p>
          <p className="text-xl">We invite you to submit your groundbreaking papers for our upcoming conference</p>
        </div>
      </header>
      <section className="py-20 px-4 max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center items-center">
          {tracks.map((track) => (
            ...
            >
              <h3 className="text-lg font-semibold text-blue-600 mb-2 text-center">{track}</h3>
              <p className="text-gray-600 text-center">Explore cutting-edge research and innovations in this exciting field.</p>
            </div>
          ))}
        </div>
      </section>
