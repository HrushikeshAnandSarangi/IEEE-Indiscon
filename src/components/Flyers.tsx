  ...
  const flyers = [
    {
      id: 1,
      src: '/flyer1.jpg',
      alt: 'IEEE INDISCON 2025 - Sustainable and Immersive Computing for Future Ecosystems',
    },
    {
      id: 2,
      src: '/flyer2.jpg',
      alt: 'IEEE INDISCON 2025 - AI-Driven Semantic Technology for 6G Sustainable Communication',
    },
    {
      id: 3,
      src: '/flyer3.jpg',
      alt: 'IEEE INDISCON 2025 - Innovation in AI for Sustainable Healthcare and Assistive Technology',
    },
  ];
